...
namespace airmily.ViewModels
{
    public class ViewImagesPageViewModel : BindableBase, INavigationAware
    {
        ...
        public async void RefreshImages()
        {
            ...
            var receipts = await _azure.GetAllImages(CurrentTransaction.ID, true);
            ...
            var goods = await _azure.GetAllImages(CurrentTransaction.ID, false);
