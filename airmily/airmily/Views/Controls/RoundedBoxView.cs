...
namespace airmily.Views.Controls
{
    public class RoundedBoxView : BoxView
    {
        public static readonly BindableProperty CornerRadiusProperty =
            /*BindableProperty.Create(nameof(CornerRadius), typeof(float), typeof(RoundedBoxView), null);*/
            BindableProperty.Create<RoundedBoxView, float>(p => p.CornerRadius, 0);


        public static readonly BindableProperty StrokeProperty =
            /*BindableProperty.Create(nameof(Stroke), typeof(Color), typeof(Color));*/
            BindableProperty.Create<RoundedBoxView, Color>(p => p.Stroke, Color.Red);

        public static readonly BindableProperty StrokeThicknessProperty =
            /*BindableProperty.Create(nameof(StrokeThickness), typeof(double), typeof(double));*/
